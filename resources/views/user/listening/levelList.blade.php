...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<!-- Themify Icons -->
	<link rel="stylesheet" href="../public/css/user/themify-icons.css">
	<!-- Bootstrap -->
	<link rel="stylesheet" href="../public/css/user/bootstrap.css">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="../public/css/user/owl.carousel.min.css">
	<link rel="stylesheet" href="../public/css/user/owl.theme.default.min.css">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="../public/css/user/magnific-popup.css">
	<!-- Superfish -->
	<link rel="stylesheet" href="../public/css/user/superfish.css">
	<!-- Easy Responsive Tabs -->
	<link rel="stylesheet" href="../public/css/user/easy-responsive-tabs.css">
	<!-- Animate.css -->
	<link rel="stylesheet" href="../public/css/user/animate.css">
	<!-- Theme Style -->
	<link rel="stylesheet" href="../public/css/user/style.css">

	<!-- Modernizr JS -->
	<script src="../public/js/user/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<body>
		...
		<header id="fh5co-header-section" role="header" class="" >
			<div class="container">
				...
				<!-- <div id="fh5co-menu-logo"> -->
					<!-- START #fh5co-logo -->
					<h1 id="fh5co-logo" class="pull-left"><a href="index.html"><img src="../public/img/common/logo.png" alt="Valet Free HTML5 Template"></a></h1>
		...
		<div id="fh5co-hero" style="background-image: url(../public/img/common/slide_2.jpg);">
				...
				<div class="col-md-12">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							...
							<h2 class="to-animate hero-animate-2">Created by <a href="#" target="_blank">FREEHTML5.co</a></h2>
		...
		<div id="fh5co-main">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="../public/img/common/img_large_1.jpg" alt="Free HTML5 Bootstrap template" class="img-responsive">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="../public/img/common/img_large_2.jpg" alt="Free HTML5 Bootstrap template" class="img-responsive">
								<div class="fh5co-card-body">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="../public/img/common/img_large_3.jpg" alt="Free HTML5 Bootstrap template" class="img-responsive">
								<div class="fh5co-card-body">
									<h3>Web Analyst</h3>
									<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste sunt porro delectus cum officia magnam.</p>
								</div>
			...
			<div class="animate-box fh5co-product-2">
				<div class="fh5co-half img" style="background-image: url(../public/img/common/img_large_6.jpg);">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 footer-box text-center">
						...
						<p>&copy; 2015 Free Valet. All Rights Reserved. <br>Designed by <a href="http://freehtml5.co" target="_blank">FREEHTML5.co</a> Images by: <a href="#" target="_blank">Unsplash</a></p>
						</div>
					</div>
		...
		<!-- jQuery -->
        <script src="../public/js/user/jquery-1.10.2.min.js"></script>
		<!-- jQuery Easing -->
		<script src="../public/js/user/jquery.easing.1.3.js"></script>
		<!-- Bootstrap -->
		<script src="../public/js/user/bootstrap.js"></script>
		<!-- Owl carousel -->
		<script src="../public/js/user/owl.carousel.min.js"></script>
		<!-- Magnific Popup -->
		<script src="../public/js/user/jquery.magnific-popup.min.js"></script>
		<!-- Superfish -->
		<script src="../public/js/user/hoverIntent.js"></script>
		<script src="../public/js/user/superfish.js"></script>
		<!-- Easy Responsive Tabs -->
		<script src="../public/js/user/easyResponsiveTabs.js"></script>
		<!-- FastClick for Mobile/Tablets -->
		<script src="../public/js/user/fastclick.js"></script>
		<!-- Parallax -->
		<script src="../public/js/user/jquery.parallax-scroll.min.js"></script>
		<!-- Waypoints -->
		<script src="../public/js/user/jquery.waypoints.min.js"></script>
		<!-- Main JS -->
