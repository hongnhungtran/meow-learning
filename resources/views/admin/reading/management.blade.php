...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            ...
            <a href="{!! action('Admin\ReadingLessonController@index') !!}" class="small-box-footer">
...
<div class="row">
    ...
    <!-- /.col -->
    <div class="col-md-3 col-sm-6 col-xs-12">
        <a href="{!! action('Admin\ReadingExerciseController@create') !!}">
            <div class="info-box">
                <span class="info-box-icon bg-yellow"><i class="fa fa-plus-square"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Add new</span>
                    <span class="info-box-number">Reading Exercise</span>
                </div>
                <!-- /.info-box-content -->
            </div>
        </a>
