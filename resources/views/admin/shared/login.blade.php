...
<div class="container">
	<h1 class="welcome text-center">Welcome to <br> <strong>Meow</strong> Learning</h1>
  <div class="card card-container">
  <hr>

    <form class="form-signin" action="{{ action('Admin\ManagementController@doLogin') }}" method="post">
    	{{csrf_field()}}
      ...
      <input type="text" id="inputEmail" class="login_box" placeholder="Username" name="username" value="{{ old('username') }}" required autofocus>
      ...
      <input type="password" id="inputPassword" class="login_box" placeholder="Password" name="password" value="{{ old('password') }}" required>
