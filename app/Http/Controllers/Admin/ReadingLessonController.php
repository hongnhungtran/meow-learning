...
class ReadingLessonController extends Controller
{
    ...
    public function index()
    {
        ...
        $reading_lessons = $lesson->get_reading_lesson()->paginate(10);

        return view('admin.reading.lessonList', compact('reading_lessons'))
    ...
    public function create()
    {
        ...
        return view('admin.reading.lessonAdd', compact('levels'));
    }
    ...
    {
        return view('admin.reading.exerciseShow');
    }
    ...
    public function edit($id)
    {
        ...
        $reading_lesson = Lesson::find($id);

        return view('admin.reading.lessonEdit', compact('reading_lesson', 'levels', 'id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('reading-lesson-list')
            ->with('status', 'Reading lesson updated successfully');
    }
